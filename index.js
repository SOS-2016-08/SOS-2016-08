...
app.get("/about/social-situation",(req,res)=>{
	fs.readFile('socialsituation.json','utf-8',(err,content)=>{
		...
		res.write("<table> <tr> <td><strong> Country <strong></td><td><strong>Year</strong></td></tr></table>")

		
		socialsituation.forEach((linea)=>{
			res.write("<li>"+<tr><td>linea.country </td></tr> +" , "+linea.year+" , "+linea.sales+" , "+linea.digital+", "+linea.nodigital+"</li>");
		});
		res.write("</ul>--------------------------------------------------------------------------</body></html>");
		res.end();
